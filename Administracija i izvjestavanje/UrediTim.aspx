<%@ Page Title="" Language="C#" MasterPageFile="~/FormeEntitetaSite.Master" AutoEventWireup="true" CodeBehind="UrediTim.aspx.cs" Inherits="Administracija_i_izvjestavanje.UrediTim" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="display-4 text-center">
                <asp:Label ID="lblUrediTimHeader" Text="Uredi tim" runat="server" meta:resourcekey="lblUrediTimHeaderResource1" /></h1>
        </div>
        <div class="form-tim">
