<%@ Page Title="" Language="C#" MasterPageFile="~/FormeEntitetaSite.Master" AutoEventWireup="true" CodeBehind="UrediProjekt.aspx.cs" Inherits="Administracija_i_izvjestavanje.UrediProjekt" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="display-4 text-center">
                <asp:Label ID="lblUrediProjektHeader" Text="Uredi projekt" runat="server" meta:resourcekey="lblUrediProjektHeaderResource1" /></h1>
        </div>
