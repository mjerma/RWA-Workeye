<%@ Page Title="" Language="C#" MasterPageFile="~/FormeEntitetaSite.Master" AutoEventWireup="true" CodeBehind="DodajKlijenta.aspx.cs" Inherits="Administracija_i_izvjestavanje.DodajKlijenta" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="display-4 text-center">
                <asp:Label ID="lblDodajKlijentaHeader" Text="Dodaj klijenta" runat="server" meta:resourcekey="lblDodajKlijentaHeaderResource1" /></h1>
        </div>
        <div class="form-klijent">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="txtEmail" runat="server" TextMode="Email" CssClass="form-control" meta:resourcekey="txtEmailResource1" />
            </div>
            <div class="form-row">
